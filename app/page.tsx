...
const basePath = '/cnno-1775101266145';
...
export default function Home() {
  ...
  const products = [{ n: 'Product 1', d: 'OG Rolls: Our signature sweet rolls, soft and fluffy on the inside, crispy on the outside, and filled with a hint of sweetness that will leave you craving more.', icon: 'domain' }, { n: 'Product 2', d: 'Pistachio Rolls: A unique twist on our classic recipe, featuring a delicate pistachio flavor and a touch of green tea, perfect for adventurous palates.', icon: 'architecture' }, { n: 'Product 3', d: 'Chocolate Rolls: For chocolate lovers, our rich, velvety rolls are filled with decadent dark chocolate and topped with a sprinkle of sea salt, satisfying any sweet tooth.', icon: 'chair' }, { n: 'Product 4', d: 'Baby Rolls: Bite-sized versions of our beloved OG Rolls, perfect for snacking on-the-go or sharing with friends and family.', icon: 'eco' }, { n: 'Product 5', d: 'Party Box: A curated assortment of our most popular rolls, carefully packaged for special occasions or everyday celebrations, because every day deserves a little sweetness.', icon: 'precision_manufacturing' }];
      ...
      <section id="about" className="py-24 bg-surface">
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div><h4 className="font-bold text-primary">Mission</h4><p className="text-sm text-on-surface-variant">To craft high-quality, delicious sweet rolls that inspire connection and happiness, while providing exceptional customer experiences.</p></div>
